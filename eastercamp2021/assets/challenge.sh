...
function kc_start_tasks()
{
  ...
  kc_task \
      "$(tput sgr 0) Um herauszufinden in welchem Raum du dich gerade befindest Tippe $(tput setaf 3)pwd$(tput sgr 0) in das Terminal (links) und bestätige mit der <Enter> Taste.\n\n" \
