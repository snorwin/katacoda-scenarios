...
function kc_start_tasks()
{
  ...
  kc_task \
      "$(tput sgr 0)$(tput setaf 4) Um herauszufinden in welchem Raum du dich gerade befindest Tippe $(tput setaf 3)pwd$(tput sgr 0)$(tput setaf 4) in das Terminal (links) und bestätige mit der <Enter> Taste.$(tput sgr 0)\n\n" \
  ...
  kc_task \
      "$(tput sgr 0)$(tput setaf 4) Du kannst dich in einem Raum (Ordner) umzusehen in dem du dich gerade befindest mit dem Kommando $(tput setaf 3)ls$(tput sgr 0)$(tput setaf 4). Probiere es doch gleich mal aus.$(tput sgr 0)" \
